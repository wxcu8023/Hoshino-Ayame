...
@sv.on_command('gacha_11', deny_tip=GACHA_DISABLE_NOTICE, aliases=gacha_11_aliases, only_to_me=True)
async def gacha_11(session:CommandSession):
    SUPER_LUCKY_LINE = 170
    ...
    card9 = cardram()
    card10 = cardram()
    if (card1+card2+card3+card4+card5+card6+card7+card8+card9+card10) == 60:
        card10 = 5
    card = f'{card1}{card2}{card3}{card4}{card5}\n{card6}{card7}{card8}{card9}{card10}'
